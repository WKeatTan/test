...
const updateOptions = {
  ...
  gitRepo: "test", // [Required] Your Repo Name
  gitUsername: "WKeatTan", // [Required] Your GitHub Username.
  ...
  appName: "test", //[Required] The Name of the app archive and the app folder.
  appExecutableName: "TEST.exe", //[Required] The Executable of the Application to be Run after updating.
